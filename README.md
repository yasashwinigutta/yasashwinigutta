...
![PTC Creo](https://img.shields.io/badge/PTC_Creo-0093D0?style=for-the-badge)
...
🏆 **1st Place Winning Strategy**

Developed intelligent game strategies for a dynamic multiplayer environment involving real-time path planning, opponent prediction, resource management, and adaptive decision-making under continuously evolving game rules.

🔗 https://github.com/yasashwinigutta/Itestra_Hackathon_Snake_Bot_Stratrgies

---

### 📢 RWTH Job Alert Bot

An automated Telegram bot that monitors RWTH student assistant job postings and instantly sends notifications when new positions matching selected keywords become available.

🔗 https://github.com/yasashwinigutta/rwth-job-alert-bot
